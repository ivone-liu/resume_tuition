...
如果你需要将你的简历完美地打印在一张纸上，有几件事情需要牢记。最艰难的挑战是需要删除一些文字来适应单页面。
